      ...
      <div className="container-shell">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="card-surface p-8 sm:p-10">
            ...
            />
            <div className="mt-8 rounded-[2rem] border border-dashed border-brand-200 bg-brand-50/80 p-6 dark:border-brand-900/70 dark:bg-brand-950/30">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="card-surface h-56 bg-gradient-to-br from-brand-100 to-white p-6 dark:from-brand-950/40 dark:to-slate-900">
            ...
            <div className="card-surface h-56 bg-gradient-to-br from-mint-100 to-white p-6 dark:from-mint-950/30 dark:to-slate-900">
              <div className="rounded-[1.75rem] border border-white/70 bg-white/80 p-5 dark:border-slate-800 dark:bg-slate-900/80">
